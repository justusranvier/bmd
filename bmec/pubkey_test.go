// Originally derived from: btcsuite/btcd/btcec/pubkey_test.go
...
var pubKeyTests = []pubKeyTest{
	...
	// 0437cd7f8525ceed2324359c2d0ba26006d92d85
	{
		...
		isValid: true,
		format:  bmec.TstPubkeyUncompressed,
	},
	{
	...
	// from tx 0b09c51c51ff762f00fb26217269d2a18e77a4fa87d69b3c363ab4df16543f20
	{
		...
		isValid: true,
		format:  bmec.TstPubkeyCompressed,
	},
...
func TestPubKeys(t *testing.T) {
	for _, test := range pubKeyTests {
		pk, err := bmec.ParsePubKey(test.key, bmec.S256())
		if err != nil {
			if test.isValid {
		...
		var pkStr []byte
		switch test.format {
		case bmec.TstPubkeyUncompressed:
			pkStr = (*bmec.PublicKey)(pk).SerializeUncompressed()
		case bmec.TstPubkeyCompressed:
			pkStr = (*bmec.PublicKey)(pk).SerializeCompressed()
		case bmec.TstPubkeyHybrid:
			pkStr = (*bmec.PublicKey)(pk).SerializeHybrid()
		}
